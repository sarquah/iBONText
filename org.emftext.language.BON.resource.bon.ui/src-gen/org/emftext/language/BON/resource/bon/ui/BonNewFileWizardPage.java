 ...
 */
public class BonNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public BonNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new bon file");
