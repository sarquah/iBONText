 ...
 */
public class BonHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public BonHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				org.emftext.language.BON.resource.bon.mopp.BonPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
