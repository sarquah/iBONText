 ...
 */
public class BonSourceViewerConfiguration extends org.eclipse.ui.editors.text.TextSourceViewerConfiguration {
	...
	private org.emftext.language.BON.resource.bon.ui.BonQuickAssistAssistant quickAssistAssistant;
	 ...
	 */
	public BonSourceViewerConfiguration(org.emftext.language.BON.resource.bon.IBonResourceProvider resourceProvider, org.emftext.language.BON.resource.bon.ui.IBonAnnotationModelProvider annotationModelProvider, org.emftext.language.BON.resource.bon.ui.IBonBracketHandlerProvider bracketHandlerProvider, org.emftext.language.BON.resource.bon.ui.BonColorManager colorManager) {
		super(org.emftext.language.BON.resource.bon.ui.BonUIPlugin.getDefault().getPreferenceStore());
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new org.emftext.language.BON.resource.bon.ui.BonCompletionProcessor(resourceProvider, bracketHandlerProvider), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	protected org.eclipse.jface.text.rules.ITokenScanner getScanner() {
		return new org.emftext.language.BON.resource.bon.ui.BonTokenScanner(resourceProvider.getResource(), colorManager);
	}
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new org.emftext.language.BON.resource.bon.ui.BonTextHover(resourceProvider);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new org.emftext.language.BON.resource.bon.ui.BonHyperlinkDetector(resourceProvider.getResource()) };
	}
	...
	public org.eclipse.jface.text.quickassist.IQuickAssistAssistant getQuickAssistAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new org.emftext.language.BON.resource.bon.ui.BonQuickAssistAssistant(resourceProvider, annotationModelProvider);
		}
			...
			protected org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector createSpellingProblemCollector() {
				...
				return new org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector() {
					...
					public void accept(org.eclipse.ui.texteditor.spelling.SpellingProblem problem) {
						...
						if (new org.emftext.language.BON.resource.bon.ui.BonIgnoredWordsFilter().ignoreWord(text)) {
							return;
						}
