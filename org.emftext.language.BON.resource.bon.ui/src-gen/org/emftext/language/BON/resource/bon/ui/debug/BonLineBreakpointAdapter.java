...
public class BonLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(org.emftext.language.BON.resource.bon.mopp.BonPlugin.DEBUG_MODEL_ID);
			...
			org.emftext.language.BON.resource.bon.debug.BonLineBreakpoint lineBreakpoint = new org.emftext.language.BON.resource.bon.debug.BonLineBreakpoint(resource, lineNumber + 1);
