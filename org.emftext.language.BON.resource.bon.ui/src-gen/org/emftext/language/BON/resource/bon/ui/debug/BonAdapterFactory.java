 ...
 * 
 */
package org.emftext.language.BON.resource.bon.ui.debug;

@SuppressWarnings("restriction")
public class BonAdapterFactory implements org.eclipse.core.runtime.IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adaptableObject instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new org.emftext.language.BON.resource.bon.mopp.BonMetaInformation().getSyntaxName())) {
					return new org.emftext.language.BON.resource.bon.ui.debug.BonLineBreakpointAdapter();
				}
			}
		}
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementLabelProvider.class && adaptableObject instanceof org.emftext.language.BON.resource.bon.debug.BonDebugVariable) {
			final org.emftext.language.BON.resource.bon.debug.BonDebugVariable variable = (org.emftext.language.BON.resource.bon.debug.BonDebugVariable) adaptableObject;
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementContentProvider.class && adaptableObject instanceof org.emftext.language.BON.resource.bon.debug.BonDebugVariable) {
			final org.emftext.language.BON.resource.bon.debug.BonDebugVariable variable = (org.emftext.language.BON.resource.bon.debug.BonDebugVariable) adaptableObject;
				...
				public void update(org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate[] updates) {
					try {
						for (org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate update : updates) {
							...
							org.emftext.language.BON.resource.bon.debug.BonDebugValue castedValue = (org.emftext.language.BON.resource.bon.debug.BonDebugValue) value;
