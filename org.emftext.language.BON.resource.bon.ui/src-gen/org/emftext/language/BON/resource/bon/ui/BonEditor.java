...
/**
 * A text editor for 'bon' models.
 * <p>
 * This editor has id
 * <code>org.emftext.language.BON.resource.bon.ui.BonEditor</code>
 * The editor's context menu has id
 * <code>org.emftext.language.BON.resource.bon.EditorContext</code>.
 * The editor's ruler context menu has id
 * <code>org.emftext.language.BON.resource.bon.EditorRuler</code>.
 * </p>
 */
public class BonEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, org.emftext.language.BON.resource.bon.IBonResourceProvider, org.emftext.language.BON.resource.bon.ui.IBonBracketHandlerProvider, org.emftext.language.BON.resource.bon.ui.IBonAnnotationModelProvider {
	
	private org.emftext.language.BON.resource.bon.ui.BonHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.emftext.language.BON.resource.bon.ui.BonCodeFoldingManager codeFoldingManager;
	private org.emftext.language.BON.resource.bon.ui.BonBackgroundParsingStrategy bgParsingStrategy = new org.emftext.language.BON.resource.bon.ui.BonBackgroundParsingStrategy();
	private java.util.Collection<org.emftext.language.BON.resource.bon.IBonBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.emftext.language.BON.resource.bon.IBonBackgroundParsingListener>();
	private org.emftext.language.BON.resource.bon.ui.BonColorManager colorManager = new org.emftext.language.BON.resource.bon.ui.BonColorManager();
	private org.emftext.language.BON.resource.bon.ui.BonOutlinePage outlinePage;
	...
	private org.emftext.language.BON.resource.bon.ui.BonPropertySheetPage propertySheetPage;
	...
	private org.emftext.language.BON.resource.bon.ui.IBonBracketHandler bracketHandler;
	...
	public BonEditor() {
		super();
		setSourceViewerConfiguration(new org.emftext.language.BON.resource.bon.ui.BonSourceViewerConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), BonEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.emftext.language.BON.resource.bon.IBonTextResource currentResource = getResource();
				...
				org.emftext.language.BON.resource.bon.ui.BonUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("org.emftext.language.BON.resource.bon.EditorContext");
		setRulerContextMenuId("org.emftext.language.BON.resource.bon.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.emftext.language.BON.resource.bon.ui.BonHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.emftext.language.BON.resource.bon.ui.BonCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.emftext.language.BON.resource.bon.mopp.BonNature.activate(inputFile.getProject());
		...
		org.emftext.language.BON.resource.bon.IBonTextResource loadedResource = (org.emftext.language.BON.resource.bon.IBonTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.emftext.language.BON.resource.bon.IBonTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.emftext.language.BON.resource.bon.IBonTextResource) {
					setResource((org.emftext.language.BON.resource.bon.IBonTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					org.emftext.language.BON.resource.bon.ui.BonUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the BonEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				org.emftext.language.BON.resource.bon.ui.BonUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.emftext.language.BON.resource.bon.IBonTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.emftext.language.BON.resource.bon.ui.BonOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.emftext.language.BON.resource.bon.ui.BonPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.emftext.language.BON.resource.bon.IBonTextResource textResource = (org.emftext.language.BON.resource.bon.IBonTextResource) element.eResource();
			org.emftext.language.BON.resource.bon.IBonLocationMap locationMap = textResource.getLocationMap();
			int destination = locationMap.getCharStart(element);
			int length = locationMap.getCharEnd(element) + 1 - destination;
			
			org.emftext.language.BON.resource.bon.IBonTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.emftext.language.BON.resource.bon.IBonTextToken token = lexer.getNextToken();
			...
			org.emftext.language.BON.resource.bon.ui.BonUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!BonEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(org.emftext.language.BON.resource.bon.IBonBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.emftext.language.BON.resource.bon.IBonBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public org.emftext.language.BON.resource.bon.ui.IBonBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(org.emftext.language.BON.resource.bon.ui.IBonBracketHandler bracketHandler) {
	...
	private boolean setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.eclipse.jface.viewers.IStructuredSelection) {
			...
			if (object instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (!(resource instanceof org.emftext.language.BON.resource.bon.IBonTextResource)) {
					return false;
				}
				org.emftext.language.BON.resource.bon.IBonTextResource textResource = (org.emftext.language.BON.resource.bon.IBonTextResource) resource;
				org.emftext.language.BON.resource.bon.IBonLocationMap locationMap = textResource.getLocationMap();
				int destination = locationMap.getCharStart(element);
				if (destination < 0) {
					destination = 0;
