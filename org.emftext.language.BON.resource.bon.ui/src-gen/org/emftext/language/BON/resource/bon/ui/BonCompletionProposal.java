 ...
 */
public class BonCompletionProposal implements java.lang.Comparable<BonCompletionProposal> {
	 ...
	 */
	private org.emftext.language.BON.resource.bon.mopp.BonExpectedTerminal expectedTerminal;
	...
	public BonCompletionProposal(org.emftext.language.BON.resource.bon.mopp.BonExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public BonCompletionProposal(org.emftext.language.BON.resource.bon.mopp.BonExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public BonCompletionProposal(org.emftext.language.BON.resource.bon.mopp.BonExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public org.emftext.language.BON.resource.bon.mopp.BonExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof BonCompletionProposal) {
			BonCompletionProposal other = (BonCompletionProposal) object;
	...
	public int compareTo(BonCompletionProposal object) {
		if (object instanceof BonCompletionProposal) {
			BonCompletionProposal other = (BonCompletionProposal) object;
