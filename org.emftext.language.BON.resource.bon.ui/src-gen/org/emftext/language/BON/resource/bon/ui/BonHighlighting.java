 ...
 */
public class BonHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static org.emftext.language.BON.resource.bon.ui.BonPositionHelper positionHelper = new org.emftext.language.BON.resource.bon.ui.BonPositionHelper();
	...
	private org.emftext.language.BON.resource.bon.ui.BonTokenScanner scanner;
	...
	private org.emftext.language.BON.resource.bon.ui.BonEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private org.emftext.language.BON.resource.bon.ui.BonOccurrence occurrence;
	private org.emftext.language.BON.resource.bon.ui.BonBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.emftext.language.BON.resource.bon.IBonBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public BonHighlighting(org.emftext.language.BON.resource.bon.IBonTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.emftext.language.BON.resource.bon.ui.BonColorManager colorManager, org.emftext.language.BON.resource.bon.ui.BonEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = org.emftext.language.BON.resource.bon.ui.BonUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new org.emftext.language.BON.resource.bon.ui.BonTokenScanner(textResource, colorManager);
		occurrence = new org.emftext.language.BON.resource.bon.ui.BonOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new org.emftext.language.BON.resource.bon.ui.BonBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(org.emftext.language.BON.resource.bon.ui.BonPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.emftext.language.BON.resource.bon.ui.BonPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.emftext.language.BON.resource.bon.ui.BonEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, org.emftext.language.BON.resource.bon.ui.BonPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, org.emftext.language.BON.resource.bon.ui.BonPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(org.emftext.language.BON.resource.bon.ui.BonPositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.emftext.language.BON.resource.bon.ui.BonEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
