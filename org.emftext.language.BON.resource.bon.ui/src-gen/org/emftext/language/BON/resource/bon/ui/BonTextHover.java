 ...
 */
public class BonTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private org.emftext.language.BON.resource.bon.IBonHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.emftext.language.BON.resource.bon.ui.BonBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.emftext.language.BON.resource.bon.ui.BonBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.emftext.language.BON.resource.bon.ui.BonDocBrowserInformationControlInput infoInput = (org.emftext.language.BON.resource.bon.ui.BonDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.emftext.language.BON.resource.bon.ui.BonHyperlink hyperlink = new org.emftext.language.BON.resource.bon.ui.BonHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.emftext.language.BON.resource.bon.ui.BonBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.emftext.language.BON.resource.bon.ui.BonBrowserInformationControl iControl = new org.emftext.language.BON.resource.bon.ui.BonBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof org.emftext.language.BON.resource.bon.ui.BonDocBrowserInformationControlInput) {
							org.emftext.language.BON.resource.bon.ui.BonDocBrowserInformationControlInput input = (org.emftext.language.BON.resource.bon.ui.BonDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.emftext.language.BON.resource.bon.ui.BonBrowserInformationControl.isAvailable(parent)) {
				org.emftext.language.BON.resource.bon.ui.BonBrowserInformationControl iControl = new org.emftext.language.BON.resource.bon.ui.BonBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public BonTextHover(org.emftext.language.BON.resource.bon.IBonResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new org.emftext.language.BON.resource.bon.ui.BonUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((org.emftext.language.BON.resource.bon.ui.BonDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private org.emftext.language.BON.resource.bon.ui.BonDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private org.emftext.language.BON.resource.bon.ui.BonDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.emftext.language.BON.resource.bon.ui.BonDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.emftext.language.BON.resource.bon.ui.BonHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			org.emftext.language.BON.resource.bon.ui.BonHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.emftext.language.BON.resource.bon.ui.BonHTMLPrinter.insertPageProlog(buffer, 0, org.emftext.language.BON.resource.bon.ui.BonTextHover.getStyleSheet());
			org.emftext.language.BON.resource.bon.ui.BonHTMLPrinter.addPageEpilog(buffer);
			return new org.emftext.language.BON.resource.bon.ui.BonDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = org.emftext.language.BON.resource.bon.ui.BonHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.emftext.language.BON.resource.bon.ui.BonUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return org.emftext.language.BON.resource.bon.util.BonStreamUtil.getContent(styleSheetURL.openStream());
