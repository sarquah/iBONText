 ...
 * olInput</code>.
 */
public class BonDocBrowserInformationControlInput {
	
	private final BonDocBrowserInformationControlInput fPrevious;
	private BonDocBrowserInformationControlInput fNext;
	 ...
	 */
	public BonDocBrowserInformationControlInput(BonDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public BonDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public BonDocBrowserInformationControlInput getNext() {
		return fNext;
	}
