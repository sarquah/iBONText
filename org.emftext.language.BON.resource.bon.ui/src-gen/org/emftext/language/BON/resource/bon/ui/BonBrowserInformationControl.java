 ...
 * @since 3.2
 */
public class BonBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.emftext.language.BON.resource.bon.ui.BonDocBrowserInformationControlInput fInput;
	 ...
	 */
	public BonBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public BonBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public BonBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.emftext.language.BON.resource.bon.ui.BonDocBrowserInformationControlInput);
		...
		fInput= (org.emftext.language.BON.resource.bon.ui.BonDocBrowserInformationControlInput) input;
		...
		org.emftext.language.BON.resource.bon.ui.BonHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.emftext.language.BON.resource.bon.ui.BonHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public org.emftext.language.BON.resource.bon.ui.BonDocBrowserInformationControlInput getInput() {
		return fInput;
	}
