...
public class BonMarkerResolutionGenerator implements org.eclipse.ui.IMarkerResolutionGenerator {
	...
	public org.eclipse.ui.IMarkerResolution[] getResolutions(org.eclipse.core.resources.IMarker marker) {
		try {
			...
			if (resource instanceof org.eclipse.core.resources.IFile) {
				...
				rs.getLoadOptions().put(org.emftext.language.BON.resource.bon.IBonOptions.DISABLE_CREATING_MARKERS_FOR_PROBLEMS, "true");
				org.eclipse.emf.ecore.resource.Resource emfResource = rs.getResource(uri, true);
				if (emfResource instanceof org.emftext.language.BON.resource.bon.mopp.BonResource) {
					org.emftext.language.BON.resource.bon.mopp.BonResource customResource = (org.emftext.language.BON.resource.bon.mopp.BonResource) emfResource;
					org.eclipse.emf.ecore.util.EcoreUtil.resolveAll(customResource);
					java.util.Collection<org.emftext.language.BON.resource.bon.IBonQuickFix> quickFixes = getQuickFixes(customResource, marker);
					java.util.List<org.eclipse.ui.IMarkerResolution2> resolutions = new java.util.ArrayList<org.eclipse.ui.IMarkerResolution2>();
					for (final org.emftext.language.BON.resource.bon.IBonQuickFix quickFix : quickFixes) {
						resolutions.add(new org.eclipse.ui.IMarkerResolution2() {
							...
							public void run(org.eclipse.core.resources.IMarker marker) {
								...
								try {
									...
									org.emftext.language.BON.resource.bon.ui.BonUIPlugin.logError("Exception while applying quick fix", e);
								}
							}
			...
			org.emftext.language.BON.resource.bon.ui.BonUIPlugin.logError("Exception while computing quick fix resolutions", e);
		}
		return new org.eclipse.ui.IMarkerResolution[] {};
	}
	
	public java.util.Collection<org.emftext.language.BON.resource.bon.IBonQuickFix> getQuickFixes(org.emftext.language.BON.resource.bon.IBonTextResource resource, org.eclipse.core.resources.IMarker marker) {
		...
		try {
			...
			if (quickFixContexts != null) {
				...
				for (String quickFixContext : quickFixContextParts) {
					org.emftext.language.BON.resource.bon.IBonQuickFix quickFix = resource.getQuickFix(quickFixContext);
					if (quickFix != null) {
