 ...
 */
public class BonLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new org.emftext.language.BON.resource.bon.mopp.BonMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(org.emftext.language.BON.resource.bon.launch.BonLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			org.emftext.language.BON.resource.bon.mopp.BonPlugin.logError("Exception while launching selection", e);
		}
	}
