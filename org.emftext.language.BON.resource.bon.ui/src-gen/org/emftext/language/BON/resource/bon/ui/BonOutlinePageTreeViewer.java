 ...
 * a specified depth.
 */
public class BonOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public BonOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = org.emftext.language.BON.resource.bon.util.BonStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof org.emftext.language.BON.resource.bon.ui.BonEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.emftext.language.BON.resource.bon.mopp.BonPlugin.logError("Exception while refreshing outline view", e);
		}
	}
