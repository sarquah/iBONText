 ...
 */
public class BonUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.emftext.language.BON.resource.bon.ui";
	public static final String EDITOR_ID = "org.emftext.language.BON.resource.bon.ui.BonEditor";
	...
	private static BonUIPlugin plugin;
	...
	public static BonUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, BonUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, BonUIPlugin.PLUGIN_ID, message);
		}
		final BonUIPlugin pluginInstance = BonUIPlugin.getDefault();
