 ...
 */
public class BonSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public BonSyntaxColoringPreferencePage() {
		super();
		
		org.emftext.language.BON.resource.bon.mopp.BonMetaInformation metaInformation = new org.emftext.language.BON.resource.bon.mopp.BonMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = org.emftext.language.BON.resource.bon.ui.BonSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.BON.resource.bon.ui.BonSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = org.emftext.language.BON.resource.bon.ui.BonSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.BON.resource.bon.ui.BonSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = org.emftext.language.BON.resource.bon.ui.BonSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.BON.resource.bon.ui.BonSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = org.emftext.language.BON.resource.bon.ui.BonSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.BON.resource.bon.ui.BonSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = org.emftext.language.BON.resource.bon.ui.BonSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.BON.resource.bon.ui.BonSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = org.emftext.language.BON.resource.bon.ui.BonSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.BON.resource.bon.ui.BonSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		org.emftext.language.BON.resource.bon.ui.BonPixelConverter pixelConverter = new org.emftext.language.BON.resource.bon.ui.BonPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof org.emftext.language.BON.resource.bon.ui.BonEditor) {
			org.emftext.language.BON.resource.bon.ui.BonEditor emfTextEditor = (org.emftext.language.BON.resource.bon.ui.BonEditor) editor;
