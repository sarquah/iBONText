 ...
 */
public class BonBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.emftext.language.BON.resource.bon.IBonTextResource resource, final org.emftext.language.BON.resource.bon.ui.BonEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final org.emftext.language.BON.resource.bon.IBonTextResource resource, final org.emftext.language.BON.resource.bon.ui.BonEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final org.emftext.language.BON.resource.bon.IBonTextResource resource, final org.emftext.language.BON.resource.bon.ui.BonEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof org.emftext.language.BON.resource.bon.mopp.BonResource) {
							org.emftext.language.BON.resource.bon.mopp.BonResource concreteResource = (org.emftext.language.BON.resource.bon.mopp.BonResource) resource;
