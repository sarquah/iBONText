 ...
 */
public class BonCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.emftext.language.BON.resource.bon.IBonBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.emftext.language.BON.resource.bon.ui.BonEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.emftext.language.BON.resource.bon.ui.BonEditor) {
				org.emftext.language.BON.resource.bon.ui.BonEditor editor = (org.emftext.language.BON.resource.bon.ui.BonEditor) workbenchPart;
	...
	protected org.emftext.language.BON.resource.bon.ui.BonEditor editor;
	 ...
	 */
	public BonCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.emftext.language.BON.resource.bon.ui.BonEditor textEditor) {
	...
	private void addCloseListener(final org.emftext.language.BON.resource.bon.ui.BonEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.emftext.language.BON.resource.bon.ui.BonUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.emftext.language.BON.resource.bon.IBonTextResource textResource = (org.emftext.language.BON.resource.bon.IBonTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
