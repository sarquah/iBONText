 ...
 */
public class BonNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new org.emftext.language.BON.resource.bon.mopp.BonMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("org.emftext.language.BON.resource.bon.ui");
							...
							String natureID = org.emftext.language.BON.resource.bon.mopp.BonNature.NATURE_ID;
							...
							for (String builderID : org.emftext.language.BON.resource.bon.mopp.BonNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								org.emftext.language.BON.resource.bon.mopp.BonMetaInformation info = new org.emftext.language.BON.resource.bon.mopp.BonMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = org.emftext.language.BON.resource.bon.ui.BonUIPlugin.getDefault().getBundle();
