...
public class BonBracketSet {
	...
	private java.util.ArrayList<org.emftext.language.BON.resource.bon.IBonBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements org.emftext.language.BON.resource.bon.IBonBracketPair {
	 ...
	 */
	private class ClosingListener implements org.emftext.language.BON.resource.bon.ui.IBonBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.emftext.language.BON.resource.bon.IBonBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public BonBracketSet(org.emftext.language.BON.resource.bon.ui.BonEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new org.emftext.language.BON.resource.bon.mopp.BonMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.emftext.language.BON.resource.bon.IBonBracketPair>();
	 ...
	 */
	public org.emftext.language.BON.resource.bon.IBonBracketPair getBracketPair(String opening, String closing) {
		for (org.emftext.language.BON.resource.bon.IBonBracketPair bracketPair : bracketPairs) {
	...
	public org.emftext.language.BON.resource.bon.IBonBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(org.emftext.language.BON.resource.bon.IBonBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.emftext.language.BON.resource.bon.ui.BonPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.emftext.language.BON.resource.bon.IBonBracketPair remove(String opening, String closing) {
		for (org.emftext.language.BON.resource.bon.IBonBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.emftext.language.BON.resource.bon.IBonBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.emftext.language.BON.resource.bon.ui.BonPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.emftext.language.BON.resource.bon.ui.BonPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
