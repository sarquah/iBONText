...
public class BonStackFrame extends org.emftext.language.BON.resource.bon.debug.BonDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private org.emftext.language.BON.resource.bon.debug.BonDebugTarget target;
	private String name;
	private int id;
	...
	public BonStackFrame(org.emftext.language.BON.resource.bon.debug.BonDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = org.emftext.language.BON.resource.bon.util.BonStringUtil.decode(data, ',');
	...
	private org.emftext.language.BON.resource.bon.debug.BonDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		org.emftext.language.BON.resource.bon.debug.BonStackFrame other = (org.emftext.language.BON.resource.bon.debug.BonStackFrame) obj;
		if (name == null) {
