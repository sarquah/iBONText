 ...
 */
public class BonDefaultTokenResolver implements org.emftext.language.BON.resource.bon.IBonTokenResolver {
	 ...
	 */
	public BonDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public BonDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, org.emftext.language.BON.resource.bon.IBonTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : org.emftext.language.BON.resource.bon.grammar.BonGrammarInformationProvider.INSTANCE.getKeywords()) {
