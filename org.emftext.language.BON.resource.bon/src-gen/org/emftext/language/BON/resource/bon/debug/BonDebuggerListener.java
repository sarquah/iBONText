 ...
 * code).
 */
public class BonDebuggerListener<ResultType, ContextType> implements Runnable {
	...
	private org.emftext.language.BON.resource.bon.debug.AbstractBonDebuggable debuggable;
	/**
	 ...
	 */
	private java.util.Map<Long, org.emftext.language.BON.resource.bon.util.BonPair<String, Object>> objectMap = new java.util.LinkedHashMap<Long, org.emftext.language.BON.resource.bon.util.BonPair<String, Object>>();
	...
	public BonDebuggerListener(int requestPort) {
		super();
	...
	private void runDebugger() throws java.io.IOException {
		...
		org.emftext.language.BON.resource.bon.debug.BonDebugMessage command;
		while (!stop) {
			command = communicationHelper.receive(reader);
			if (command == null) {
				break;
			}
			if (command.hasType(org.emftext.language.BON.resource.bon.debug.EBonDebugMessageTypes.EXIT)) {
				debuggable.terminate();
				stop = true;
			} else if (command.hasType(org.emftext.language.BON.resource.bon.debug.EBonDebugMessageTypes.RESUME)) {
				debuggable.resume();
			} else if (command.hasType(org.emftext.language.BON.resource.bon.debug.EBonDebugMessageTypes.STEP_OVER)) {
				debuggable.stepOver();
			} else if (command.hasType(org.emftext.language.BON.resource.bon.debug.EBonDebugMessageTypes.STEP_INTO)) {
				debuggable.stepInto();
			} else if (command.hasType(org.emftext.language.BON.resource.bon.debug.EBonDebugMessageTypes.STEP_RETURN)) {
				debuggable.stepReturn();
			} else if (command.hasType(org.emftext.language.BON.resource.bon.debug.EBonDebugMessageTypes.ADD_LINE_BREAKPOINT)) {
			...
			} else if (command.hasType(org.emftext.language.BON.resource.bon.debug.EBonDebugMessageTypes.REMOVE_LINE_BREAKPOINT)) {
				String location = command.getArgument(0);
				int line = Integer.parseInt(command.getArgument(1));
				debuggable.removeLineBreakpoint(location, line);
			} else if (command.hasType(org.emftext.language.BON.resource.bon.debug.EBonDebugMessageTypes.GET_STACK)) {
				final String[] stack = debuggable.getStack();
				String controlStack = org.emftext.language.BON.resource.bon.util.BonStringUtil.encode('#', stack);
				org.emftext.language.BON.resource.bon.debug.BonDebugMessage message = new org.emftext.language.BON.resource.bon.debug.BonDebugMessage(org.emftext.language.BON.resource.bon.debug.EBonDebugMessageTypes.GET_STACK_RESPONSE, new String[] {controlStack});
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(org.emftext.language.BON.resource.bon.debug.EBonDebugMessageTypes.GET_FRAME_VARIABLES)) {
				...
				org.emftext.language.BON.resource.bon.debug.BonDebugMessage message = new org.emftext.language.BON.resource.bon.debug.BonDebugMessage(org.emftext.language.BON.resource.bon.debug.EBonDebugMessageTypes.GET_FRAME_VARIABLES_RESPONSE, topVariableIDs);
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(org.emftext.language.BON.resource.bon.debug.EBonDebugMessageTypes.GET_VARIABLES)) {
				...
				org.emftext.language.BON.resource.bon.debug.BonDebugMessage message = new org.emftext.language.BON.resource.bon.debug.BonDebugMessage(org.emftext.language.BON.resource.bon.debug.EBonDebugMessageTypes.GET_VARIABLES_RESPONSE, varStrings);
				communicationHelper.sendEvent(message, output);
			} else {
	...
	private String convertToString(long id, Object object) {
		...
		return org.emftext.language.BON.resource.bon.util.BonStringUtil.convertToString(properties);
	}
	...
	private long getObjectID(String name, Object value) {
		org.emftext.language.BON.resource.bon.util.BonPair<String, Object> pair = new org.emftext.language.BON.resource.bon.util.BonPair<String, Object>(name, value);
	...
	public org.emftext.language.BON.resource.bon.debug.AbstractBonDebuggable getDebuggable() {
		return debuggable;
	}
	
	public void setDebuggable(org.emftext.language.BON.resource.bon.debug.AbstractBonDebuggable debuggable) {
