...
public class BonLineBreakpoint extends org.eclipse.debug.core.model.LineBreakpoint {
	
	private static final String LINE_BREAKPOINT_MARKER_ID = "org.emftext.language.BON.resource.bon.debug.lineBreakpoint.marker";
	
	public BonLineBreakpoint() {
		super();
	}
	
	public BonLineBreakpoint(final org.eclipse.core.resources.IResource resource, final int lineNumber) throws org.eclipse.debug.core.DebugException {
	...
	public void install(org.emftext.language.BON.resource.bon.debug.BonDebugTarget target) {
		try {
	...
	public void remove(org.emftext.language.BON.resource.bon.debug.BonDebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);
