...
public class BonResourceFactoryDelegator implements org.eclipse.emf.ecore.resource.Resource.Factory {
	
	protected java.util.Map<String, org.eclipse.emf.ecore.resource.Resource.Factory> factories = null;
	
	public BonResourceFactoryDelegator() {
		init();
	}
	...
	protected void init() {
		...
		if (new org.emftext.language.BON.resource.bon.util.BonRuntimeUtil().isEclipsePlatformAvailable()) {
			new org.emftext.language.BON.resource.bon.util.BonEclipseProxy().getResourceFactoryExtensions(factories);
		}
		if (factories.get("") == null) {
			factories.put("", new org.emftext.language.BON.resource.bon.mopp.BonResourceFactory());
		}
	}
