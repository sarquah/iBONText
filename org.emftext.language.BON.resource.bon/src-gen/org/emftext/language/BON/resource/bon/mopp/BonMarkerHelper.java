 ...
 * contains <code>org.emftext.language.BON.resource.bon.IBonTextDiagnostic</code>s
 * it uses the more precise information of this extended diagnostic type.
 */
public class BonMarkerHelper {
	
	/**
	 * The extension id of the custom marker type that is used by this text resource.
	 */
	public static final String MARKER_TYPE = org.emftext.language.BON.resource.bon.mopp.BonPlugin.PLUGIN_ID + ".problem";
	...
	private static class MarkerCommandQueue {
		...
		private java.util.List<org.emftext.language.BON.resource.bon.IBonCommand<Object>> commands = new java.util.ArrayList<org.emftext.language.BON.resource.bon.IBonCommand<Object>>();
		
		private MutexRule schedulingRule = new MutexRule();
		
		public void addCommand(org.emftext.language.BON.resource.bon.IBonCommand<Object> command) {
		...
		public void runCommands() {
			java.util.List<org.emftext.language.BON.resource.bon.IBonCommand<Object>> commandsToProcess = new java.util.ArrayList<org.emftext.language.BON.resource.bon.IBonCommand<Object>>();
			synchronized(commands) {
				commandsToProcess.addAll(commands);
				commands.clear();
			}
			for (org.emftext.language.BON.resource.bon.IBonCommand<Object> command : commandsToProcess) {
	 ...
	 */
	public void mark(org.eclipse.emf.ecore.resource.Resource resource, org.emftext.language.BON.resource.bon.IBonTextDiagnostic diagnostic) {
	...
	protected void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final org.emftext.language.BON.resource.bon.IBonTextDiagnostic diagnostic) {
		final org.emftext.language.BON.resource.bon.IBonProblem problem = diagnostic.getProblem();
		org.emftext.language.BON.resource.bon.BonEProblemType problemType = problem.getType();
		final String markerID = getMarkerID(problemType);
		COMMAND_QUEUE.addCommand(new org.emftext.language.BON.resource.bon.IBonCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					if (problem.getSeverity() == org.emftext.language.BON.resource.bon.BonEProblemSeverity.ERROR) {
					...
					org.emftext.language.BON.resource.bon.IBonTextDiagnostic textDiagnostic = (org.emftext.language.BON.resource.bon.IBonTextDiagnostic) diagnostic;
					...
					if (diagnostic instanceof org.emftext.language.BON.resource.bon.mopp.BonResource.ElementBasedTextDiagnostic) {
						org.eclipse.emf.ecore.EObject element = ((org.emftext.language.BON.resource.bon.mopp.BonResource.ElementBasedTextDiagnostic) diagnostic).getElement();
					...
					java.util.Collection<org.emftext.language.BON.resource.bon.IBonQuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
					...
					if (!sourceIDs.isEmpty()) {
						marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, org.emftext.language.BON.resource.bon.util.BonStringUtil.explode(sourceIDs, "|"));
					}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource) {
		for (org.emftext.language.BON.resource.bon.BonEProblemType nextType : org.emftext.language.BON.resource.bon.BonEProblemType.values()) {
	 ...
	 */
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, org.emftext.language.BON.resource.bon.BonEProblemType problemType) {
		final org.eclipse.core.resources.IFile file = getFile(resource);
		if (file == null) {
			return;
		}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, final org.eclipse.emf.ecore.EObject causingObject) {
		...
		final String markerID = getMarkerID(org.emftext.language.BON.resource.bon.BonEProblemType.UNKNOWN);
	 ...
	 * given type.
	 */
	public String getMarkerID(org.emftext.language.BON.resource.bon.BonEProblemType problemType) {
	...
	protected void handleException(org.eclipse.core.runtime.CoreException ce) {
		if (ce.getMessage().matches("Marker.*not found.")) {
			...
			new org.emftext.language.BON.resource.bon.util.BonRuntimeUtil().logError("Error while removing markers from resource:", ce);
		}
	}
		...
		COMMAND_QUEUE.addCommand(new org.emftext.language.BON.resource.bon.IBonCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					org.emftext.language.BON.resource.bon.mopp.BonPlugin.logError("Can't create marker.", e);
					return false;
				}
			}
		});
