...
public class BonDebugValue extends org.emftext.language.BON.resource.bon.debug.BonDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public BonDebugValue(org.emftext.language.BON.resource.bon.debug.BonDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
