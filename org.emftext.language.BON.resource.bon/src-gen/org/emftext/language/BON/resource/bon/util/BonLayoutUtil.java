...
public class BonLayoutUtil {
	...
	public void transferLayoutInformationToModel(org.eclipse.emf.ecore.EObject element) {
		...
		for (java.util.Iterator<org.emftext.language.BON.resource.bon.mopp.BonLayoutInformation> i = layoutInformationAdapter.getLayoutInformations().iterator(); i.hasNext(); ) {
			org.emftext.language.BON.resource.bon.mopp.BonLayoutInformation layoutInformation = i.next();
	...
	public void transferLayoutInformationFromModel(org.eclipse.emf.ecore.EObject element) {
		...
		if (layoutReference != null) {
			...
			for (java.util.Iterator<org.eclipse.emf.ecore.EObject> i = list.iterator(); i.hasNext(); ) {
				...
				org.emftext.language.BON.resource.bon.mopp.BonLayoutInformation layoutInformation = createLayoutInformation(layoutModelElement);
	...
	public org.eclipse.emf.ecore.EObject createLayoutInformationModelElement(org.emftext.language.BON.resource.bon.mopp.BonLayoutInformation layoutInformation, org.eclipse.emf.ecore.EPackage layoutPackage) {
		...
		org.emftext.language.BON.resource.bon.grammar.BonSyntaxElement syntaxElement = layoutInformation.getSyntaxElement();
		...
		layoutInformationModelElement.eSet(layoutInformationEClass.getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME), org.emftext.language.BON.resource.bon.grammar.BonGrammarInformationProvider.getSyntaxElementID(syntaxElement));
		return layoutInformationModelElement;
	}
	
	public org.emftext.language.BON.resource.bon.mopp.BonLayoutInformation createLayoutInformation(org.eclipse.emf.ecore.EObject layoutInformationModelElement) {
		Object object = null;
		...
		org.emftext.language.BON.resource.bon.grammar.BonSyntaxElement syntaxElement = org.emftext.language.BON.resource.bon.grammar.BonGrammarInformationProvider.getSyntaxElementByID((String) layoutInformationModelElement.eGet(layoutInformationModelElement.eClass().getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME)));
		if (objectFeature != null) {
			object = layoutInformationModelElement.eGet(objectFeature);
		} else if (syntaxElement instanceof org.emftext.language.BON.resource.bon.grammar.BonPlaceholder) {
			org.emftext.language.BON.resource.bon.grammar.BonPlaceholder placeholder = (org.emftext.language.BON.resource.bon.grammar.BonPlaceholder) syntaxElement;
			org.emftext.language.BON.resource.bon.IBonTokenResolver tokenResolver = new org.emftext.language.BON.resource.bon.mopp.BonTokenResolverFactory().createTokenResolver(placeholder.getTokenName());
			org.emftext.language.BON.resource.bon.IBonTokenResolveResult result = new org.emftext.language.BON.resource.bon.mopp.BonTokenResolveResult();
			tokenResolver.resolve(visibleTokenText, placeholder.getFeature(), result);
			object = result.getResolvedToken();
		}
		return new org.emftext.language.BON.resource.bon.mopp.BonLayoutInformation(syntaxElement, object, startOffset, hiddenTokenText, visibleTokenText);
	}
	
	public org.emftext.language.BON.resource.bon.mopp.BonLayoutInformationAdapter getLayoutInformationAdapter(org.eclipse.emf.ecore.EObject element) {
