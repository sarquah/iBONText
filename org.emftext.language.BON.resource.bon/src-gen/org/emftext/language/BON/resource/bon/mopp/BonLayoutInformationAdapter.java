...
/**
 * A BonLayoutInformationAdapter is used to store layout information that is found
 ...
 * BonLayoutInformationAdapters are attached to EObjects and aggregate multiple
 ...
 */
public class BonLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<org.emftext.language.BON.resource.bon.mopp.BonLayoutInformation> layoutInformations = new java.util.ArrayList<org.emftext.language.BON.resource.bon.mopp.BonLayoutInformation>();
	...
	public java.util.List<org.emftext.language.BON.resource.bon.mopp.BonLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(org.emftext.language.BON.resource.bon.mopp.BonLayoutInformation layoutInformation) {
