...
public class BonBuilderAdapter extends org.eclipse.core.resources.IncrementalProjectBuilder implements org.eclipse.core.resources.IResourceDeltaVisitor, org.eclipse.core.resources.IResourceVisitor {
	
	/**
	 * The ID of the default, generated builder.
	 */
	public final static String BUILDER_ID = "org.emftext.language.BON.resource.bon.builder";
	
	private org.emftext.language.BON.resource.bon.IBonBuilder defaultBuilder = new org.emftext.language.BON.resource.bon.mopp.BonBuilder();
	...
	public void build(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		...
		org.emftext.language.BON.resource.bon.IBonBuilder builder = getBuilder();
		if (builder.isBuildingNeeded(uri)) {
			org.emftext.language.BON.resource.bon.mopp.BonResource customResource = (org.emftext.language.BON.resource.bon.mopp.BonResource) resourceSet.getResource(uri, true);
			new org.emftext.language.BON.resource.bon.mopp.BonMarkerHelper().removeAllMarkers(resource, getBuilderMarkerId());
	 ...
	 */
	public org.emftext.language.BON.resource.bon.IBonBuilder getBuilder() {
	...
	public String getBuilderMarkerId() {
		return new org.emftext.language.BON.resource.bon.mopp.BonMarkerHelper().getMarkerID(org.emftext.language.BON.resource.bon.BonEProblemType.BUILDER_ERROR);
	}
	...
	public void runTaskItemBuilder(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		org.emftext.language.BON.resource.bon.mopp.BonTaskItemBuilder taskItemBuilder = new org.emftext.language.BON.resource.bon.mopp.BonTaskItemBuilder();
		new org.emftext.language.BON.resource.bon.mopp.BonMarkerHelper().removeAllMarkers(resource, taskItemBuilder.getBuilderMarkerId());
	...
	protected boolean doVisit(org.eclipse.core.resources.IResource resource, boolean removed) throws org.eclipse.core.runtime.CoreException {
		...
		if (resource instanceof org.eclipse.core.resources.IFile && resource.getName().endsWith("." + new org.emftext.language.BON.resource.bon.mopp.BonMetaInformation().getSyntaxName())) {
