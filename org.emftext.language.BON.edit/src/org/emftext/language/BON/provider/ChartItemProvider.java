...
/**
 * This is the item provider adapter for a {@link org.emftext.language.BON.Chart} object.
 * <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * @generated
 */
public class ChartItemProvider extends ItemProviderAdapter implements
	...
	protected void addExplanationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getResourceLocator(),
				getString("_UI_Chart_explanation_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_Chart_explanation_feature", "_UI_Chart_type"),
				BONPackage.Literals.CHART__EXPLANATION, true, false, false,
				null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BONPackage.Literals.CHART__CHART_INDEXING);
			childrenFeatures.add(BONPackage.Literals.CHART__CHART_PART);
		}
	...
	public String getText(Object object) {
		return getString("_UI_Chart_type");
	}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				BONPackage.Literals.CHART__CHART_INDEXING,
				BONFactory.eINSTANCE.createIndexing()));

		newChildDescriptors.add(createChildParameter(
				BONPackage.Literals.CHART__CHART_PART,
				BONFactory.eINSTANCE.createPart()));
	}
